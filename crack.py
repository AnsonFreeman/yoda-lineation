...
def drag(a, b, ratio=2):
    ...
    pyautogui.mouseDown()
    # 扰动
    pyautogui.move(random.randrange(-3, 3, 1), random.randrange(-3, 3, 1), 0.1, pyautogui.linear)
    ...
    # 扰动
    pyautogui.move(random.randrange(-10, 10, 1), random.randrange(-10, 10, 1), 0.1, pyautogui.linear)
    pyautogui.mouseUp()
